                  ...
                  <div className="flex flex-col sm:flex-row h-full">
                    <div className="sm:w-1/3 overflow-hidden">
                      <picture>
                        ...
                        <img src={course.image} alt={course.title} loading="lazy" decoding="async" width={600} height={600} className="w-full h-32 sm:h-full object-cover transition-transform duration-500 hover:scale-110" />
                      </picture>
                    </div>
