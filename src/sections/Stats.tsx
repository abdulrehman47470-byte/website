      ...
      <div className="max-w-[1350px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`mb-16 lg:mb-24 transition-all duration-1000 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="relative bg-navy rounded-[30px] lg:rounded-[40px] p-6 md:p-16 border border-white/10 overflow-hidden shadow-2xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center relative z-10">
              ...
              <div className="lg:col-span-5 space-y-6 lg:space-y-8 text-center lg:text-left">
                <div className="inline-flex items-center gap-2.5 px-4 py-1.5 bg-white/5 text-white/90 text-[10px] font-black uppercase tracking-widest rounded-lg border border-white/10">
                  ...
                  Approved CPD Provider (UK)
                </div>

                <div>
                  <h2 className="text-3xl sm:text-5xl lg:text-6xl font-black text-white leading-tight lg:leading-[1.05] tracking-tighter">
                    Internationally <br/> <span className="text-purple">Recognized Certification</span>
                  </h2>
                  <p className="mt-3 lg:mt-4 text-purple text-base lg:text-lg font-bold italic">
                    Earn a Certificate Backed by International Standards
                  </p>
                </div>

                <p className="text-white/70 text-base lg:text-lg leading-relaxed max-w-lg mx-auto lg:mx-0 font-medium">
                  At BioCareer, we are committed to delivering high-quality education that meets internationally recognized professional development standards. BioCareer is an <span className='font-bold text-white'>Approved CPD Provider through The CPD Group (UK)</span>, demonstrating our commitment to quality training, academic excellence, and continuous professional development. Upon successful completion of our programs, learners receive a <span className='font-bold text-white'>BioCareer Certificate of Completion</span> issued under our approved training framework, helping strengthen academic portfolios, research profiles, and professional development.
                </p>

                {/* Badges Stacked for Mobile */}
                <div className="flex flex-wrap justify-center lg:justify-start gap-3 lg:gap-4">
                   {[
                    { icon: ShieldCheck, label: 'Approved CPD Provider' },
                    { icon: GraduationCap, label: 'Research-Focused Training' },
                    { icon: Cpu, label: 'Expert-Led Learning' }
                   ].map(item => (
                ...
                <div className="relative group/cert w-full max-w-[280px] lg:max-w-[340px]">
                  ...
                  <picture>
                    ...
                    <img
                      ...
                      alt="BioCareer CPD Group (UK) Approved Provider Certificate"
                      loading="lazy"
                      decoding="async"
                      width={700}
                      height={495}
              ...
              <div className="lg:col-span-3 flex flex-col items-center lg:items-end space-y-8 lg:space-y-10">
                <div className="bg-white/5 p-5 lg:p-6 rounded-2xl border border-white/10 w-full">
                    ...
                    <ul className="space-y-2 lg:space-y-3 text-white/70 text-xs lg:text-sm font-medium text-left">
                        <li>• Approved CPD Provider (UK)</li>
                        <li>• Internationally Recognized Professional Development Standards</li>
                        <li>• Industry-Relevant & Research-Focused Training</li>
                        <li>• Expert-Led Learning Experience</li>
                        <li>• Digital Certificate with Unique Verification ID</li>
                        <li>• Portfolio & Career Development Support</li>
                    </ul>
                </div>
              </div>
            ...
            {/* Closing Statement */}
            <div className="relative z-10 mt-10 lg:mt-14 pt-8 lg:pt-10 border-t border-white/10">
              <p className="text-white/60 text-sm lg:text-base leading-relaxed font-medium text-center max-w-4xl mx-auto">
                Our courses are designed to combine modern research methodologies, biotechnology, artificial intelligence, data science, and computational biology with internationally recognized continuing professional development principles, providing practical skills and measurable learning outcomes.
              </p>
            </div>
          </div>
        </div>
